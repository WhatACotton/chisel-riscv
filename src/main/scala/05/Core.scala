...
class Core extends Module {
  ...
  val csignals = ListLookup(
    inst,
    List(ALU_X, OP1_RS1, OP2_RS2, MEN_X, WB_X),
    Array(
      LW -> List(ALU_ADD, OP1_RS1, OP2_IMI, MEN_X, WB_MEM),
      SW -> List(ALU_ADD, OP1_RS1, OP2_IMS, MEN_S, WB_X),
      ADD -> List(ALU_ADD, OP1_RS1, OP2_RS2, MEN_X, WB_ALU),
      ADDI -> List(ALU_ADD, OP1_RS1, OP2_IMI, MEN_X, WB_ALU),
      SUB -> List(ALU_SUB, OP1_RS1, OP2_RS2, MEN_X, WB_ALU),
      AND -> List(ALU_AND, OP1_RS1, OP2_RS2, MEN_X, WB_ALU),
      OR -> List(ALU_OR, OP1_RS1, OP2_RS2, MEN_X, WB_ALU),
      XOR -> List(ALU_XOR, OP1_RS1, OP2_RS2, MEN_X, WB_ALU),
      ANDI -> List(ALU_AND, OP1_RS1, OP2_IMI, MEN_X, WB_ALU),
      ORI -> List(ALU_OR, OP1_RS1, OP2_IMI, MEN_X, WB_ALU),
      XORI -> List(ALU_XOR, OP1_RS1, OP2_IMI, MEN_X, WB_ALU),
      ...
      BEQ -> List(BR_BEQ, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_ALU),
      BNE -> List(BR_BNE, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_ALU),
      BGE -> List(BR_BLT, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_ALU),
      BGEU -> List(BR_BGE, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_ALU),
      BLT -> List(BR_BLTU, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_ALU),
      BLTU -> List(BR_BGEU, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_ALU)
    )
  )
  ...
  val wb_data = MuxCase(
    alu_out,
    Seq((wb_sel === WB_MEM) -> io.dmem.rdata)
  )
